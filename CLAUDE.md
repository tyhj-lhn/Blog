...
**Production config:** `ecosystem.production.config.cjs` — auto-generated by `deploy-app.sh` step 4 at deploy time. Contains actual JWT secrets + DB password (chmod 600). Git-ignored.
